...
export default function Experience() {
  ...
  return (
    <section id="experience" className="py-20 bg-background">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-3 mb-1">
                            <a
                              ...
                              className="text-foreground hover:text-blue-600 dark:hover:text-blue-400 font-semibold text-lg transition-colors duration-200"
                            >
                              {exp.company}
                            </a>
                            <span className="px-3 py-1.5 bg-blue-50 dark:bg-blue-900/30 text-foreground text-xs font-medium rounded-full border border-blue-200 dark:border-blue-800">
                              {exp.type}
                            </span>
                          </div>
      ...
      {/* Fullscreen Modal */}
      {fullscreenCard && (
        <div className="fixed inset-0 z-50 bg-background backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-background border border-border rounded-lg shadow-3xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
            {(() => {
              ...
              return (
                <>
                  ...
                  <div className="bg-background border-b border-border px-4 py-3 rounded-t-lg flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <div 
                        className="w-3 h-3 bg-red-500 rounded-full hover:bg-red-600 transition-colors cursor-pointer shadow-sm"
                        onClick={closeFullscreen}
                      ></div>
                      <div 
                        className="w-3 h-3 bg-yellow-500 rounded-full hover:bg-yellow-600 transition-colors cursor-pointer shadow-sm"
                  ...
                  {/* Fullscreen Content */}
                  <div className="p-8 bg-background overflow-y-auto max-h-[calc(90vh-60px)]">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-4 mb-2">
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="text-foreground hover:text-blue-600 dark:hover:text-blue-400 font-semibold text-2xl transition-colors duration-200"
                            >
                              {exp.company}
                            </a>
                            <span className="px-4 py-2 bg-blue-50 dark:bg-blue-900/30 text-foreground text-sm font-medium rounded-full border border-blue-200 dark:border-blue-800">
                              {exp.type}
                            </span>
                          </div>
